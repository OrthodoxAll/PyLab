...
# XXXX XX** **** XXXX
# , где
# X— это цифра номера. То есть видны первые 6 цифр и последние 4 цифры,
# остальные символы отображаются звездочками, номер разбит по блокам по 4 цифры,
# разделенным пробелами. Пример работы функции:
# card_number  7000792289606361   # входной аргумент
